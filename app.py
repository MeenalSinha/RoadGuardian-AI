...
CLASS_COLORS = {
    ...
    "damage": (244, 67, 54)     # Green for general damage
}
...
def load_model(model_name: str):
    ...
    try:
        ...
        try:
            ...
            _ = model.predict(dummy, conf=0.1, imgsz=1280, verbose=False)
...
def calculate_severity(area, confidence, class_name="pothole"):
    """Calculate pothole severity based on area and confidence"""
    severity_score = (area / 1000) * confidence
    # Treat damage class as critical
    if class_name == "damage" and area > 3000:
        return "Critical", 3
    elif severity_score > 50 or area > 15000:
        return "Critical", 3
...
def annotate_image_advanced(image, results, conf_threshold):
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            severity, severity_score = calculate_severity(area, conf, cls_name)
            ...
            # Emojis don't work in cv2.putText - use class name only
...
def main():
    ...
    <div class="hero-section">
        ...
        <div style="margin-top: 1.5rem;">
            ...
            <span class="tech-badge">🎯 82% Accuracy</span>
            <span class="tech-badge">🚀 417 FPS</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab1:
        ...
        with col2:
            ...
            <div class="glass-card">
                ...
                <p style="text-align: center; color: #666;">
                    Real-time AI detection at 417 FPS with 82% accuracy and severity classification.
                </p>
            </div>
            """, unsafe_allow_html=True)
        ...
        metrics = [
            ("Accuracy", "82%", "mAP@0.5"),
            ("Speed", "417", "FPS on GPU"),
            ("Inference", "2.4ms", "Per Image"),
    ...
    with tab2:
        ...
        <div class="glass-alert-success">
            <strong>✅ Model Ready:</strong> Trained on 18,717 images | 
            81.9% mAP@0.5 | 79.2% Precision | 2.4ms inference
        </div>
        """, unsafe_allow_html=True)
        ...
        with st.sidebar:
            ...
            conf_threshold = st.slider(
                ...
                0.05, 0.50, 0.15, 0.05,  # min=0.10, default=0.15, step=0.05
                help="✅ Model confidence range: 0.02-0.88. Default 0.15 works well for most cases.",
                format="%.3f"
            )
            
            # Add helpful guidance
            st.caption("💡 **Confidence Guidance:**")
            st.caption("• 0.05-0.10: High sensitivity (~55-81 detections, thorough inspection)")
            st.caption("• 0.15: Balanced - **RECOMMENDED** (~42 detections, optimal)")
            st.caption("• 0.20-0.25: High precision (~33-38 detections, fewer false positives)")
            st.caption("• 0.30+: Very conservative (highest confidence only)")
            st.caption("")
            st.caption("**Based on test results:** 42 detections at conf=0.15 gives best balance")
            ...
            **Model Performance:**
            ...
            Confidence: 0.02-0.88 
            
            Speed: 2.4ms/image (~417 FPS)
    ...
    with tab3:
        ...
        st.markdown("""
        <div class="glass-alert-info">
            <strong>📈 Key Insight:</strong> The model achieves 82% accuracy with primary challenges 
    ...
    with tab4:
        ...
        impact_metrics = [
            ("₹20B+", "Estimated Savings", "With nationwide deployment"),
            ("40%", "Target Reduction", "In road accidents"),
            ("3x", "Faster Detection", "AI vs manual inspection"),
            ("82%", "Detection Rate", "Validated performance")
        ]
    ...
    with tab5:
        ...
        with col1:
            ...
            <div class="glass-card">
                ...
                architecture with CUDA acceleration, the system processes images at 417 FPS with 
                82% accuracy.
                </p>
                <p style="color: #666; line-height: 1.8;">
    ...
    <div class="footer">
        ...
        <div style="margin: 1.5rem 0;">
            <span class="tech-badge">🤖 YOLOv8</span>
            <span class="tech-badge">⚡ CUDA Accelerated</span>
            <span class="tech-badge">🎯 82% mAP</span>
            <span class="tech-badge">🚀 417 FPS</span>
        </div>
        ...
        <p style="opacity: 0.7; font-size: 0.95rem; margin-top: 2rem;">
            Built by NeuroIgniter | Ideas for India : INNOVATION CHALLENGE (Economic Resilience)<br>
